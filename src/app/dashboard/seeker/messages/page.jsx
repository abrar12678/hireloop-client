...
export default function SeekerMessagesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Split Panel ── */}
      <div className="bg-[#1B1B1F] border border-white/[0.05] rounded-[14px] shadow-[0_2px_8px_rgba(0,0,0,0.18)] overflow-hidden flex h-[calc(100vh-220px)] min-h-[400px]">
            ...
            {conversations.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
                ...
                <p className="text-[13px] text-[#71717A] leading-relaxed">
                  Apply to jobs and recruiters can message you!
                </p>
              </div>
            )}
          </div>
