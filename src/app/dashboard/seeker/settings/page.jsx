...
import { Card, Button, TextField, InputGroup, Textarea } from "@heroui/react";
import { FloppyDisk } from "@gravity-ui/icons";

const SeekerSettingsPage = () => {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-zinc-800 border border-zinc-700 text-white text-sm rounded-xl px-4 py-2.5 outline-none focus:border-purple-500 transition-colors placeholder-zinc-600 resize-none"
              />
            </div>
